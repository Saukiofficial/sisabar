...
export default function Authenticated({ user, header, children }) {
    ...
    const isKepsek = hasRole('Kepala Sekolah');
    ...
    const allMenus = [
        ...
        { show: isGuru, title: 'Absensi Siswa', icon: <ClipboardCheck size={20} />, href: safeRoute('guru.absensi.index'), active: isActive('guru.absensi.*') },
        ...
        { show: isGuru, title: 'Scan Saya', icon: <ScanLine size={20} />, href: safeRoute('guru.absensi-saya.index'), active: isActive('guru.absensi-saya.*') },

        // ================= ADMIN =================
        { show: isAdmin, title: 'Dashboard', icon: <Home size={20} />, href: safeRoute('admin.dashboard'), active: isActive('admin.dashboard') },
        { show: isAdmin, title: 'Verifikasi Izin', icon: <CheckSquare size={20} />, href: safeRoute('admin.izin.index'), active: isActive('admin.izin.*') },
        ...
        { show: isAdmin, title: 'Buat QR', icon: <QrCode size={20} />, href: safeRoute('admin.qr.generate'), active: isActive('admin.qr.generate') },
        { show: isAdmin, title: 'Scan Gerbang', icon: <ScanLine size={20} />, href: safeRoute('admin.absensi.gate'), active: isActive('admin.absensi.gate') },
        { show: isAdmin, title: 'Riwayat Absen', icon: <ClipboardCheck size={20} />, href: safeRoute('admin.absensi.riwayat'), active: isActive('admin.absensi.riwayat') },
