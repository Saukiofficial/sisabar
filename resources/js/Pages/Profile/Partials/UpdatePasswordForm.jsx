    ...
    return (
        <section className={className}>
            <form onSubmit={updatePassword} className="space-y-6">
                <div>
                    <InputLabel htmlFor="current_password" value="Kata Sandi Saat Ini" className="dark:text-gray-300" />
                    <TextInput
                        id="current_password"
                ...
                <div>
                    <InputLabel htmlFor="password_confirmation" value="Konfirmasi Kata Sandi" className="dark:text-gray-300" />
                    <TextInput
