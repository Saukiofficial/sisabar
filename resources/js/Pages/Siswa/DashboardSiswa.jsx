...
// Sesuaikan path import ini jika lokasi file berbeda
import AuthenticatedLayout from '@/Layouts/AuthenticatedLayout';
import { Head, Link } from '@inertiajs/react';
// Menambahkan 'Globe' untuk icon website sekolah
import { Calendar, ClipboardList, Award, BookOpen, Clock, ArrowRight, Globe } from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            <div className="py-6 sm:py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* --- MENU GRID --- */}
                {/* Mobile: 2 kolom, Tablet: 2 kolom, Desktop: 4 kolom (disesuaikan agar muat 4 item sejajar) */}
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white mb-1 sm:mb-2">Jadwal Ulangan</h3>
                            <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm mb-3 sm:mb-4 leading-relaxed line-clamp-2">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white mb-1 sm:mb-2">Latihan & Ujian</h3>
                            <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm mb-3 sm:mb-4 leading-relaxed line-clamp-2">
                    ...
                    <Link
                        ...
                        className="group bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg sm:rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-gray-700 hover:border-green-400 dark:hover:border-green-500 relative overflow-hidden"
                    >
                        <div className="absolute top-0 right-0 p-2 sm:p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white mb-1 sm:mb-2">Riwayat Nilai</h3>
                            <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm mb-3 sm:mb-4 leading-relaxed line-clamp-2">
                    ...
                    {/* [BARU] --- TOMBOL LINK RDM --- */}
                    {/* Menggunakan tag <a> standar untuk link eksternal agar membuka tab baru */}
                    <a
                        href="https://masyekhabdurrahman.inirdm.com/" // Link RDM
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg sm:rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-gray-700 hover:border-purple-400 dark:hover:border-purple-500 relative overflow-hidden"
                    >
                        <div className="absolute top-0 right-0 p-2 sm:p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                            <Globe size={60} className="sm:w-[100px] sm:h-[100px] text-purple-600 dark:text-purple-400" />
                        </div>

                        <div className="relative z-10">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center text-purple-600 dark:text-purple-400 mb-3 sm:mb-4 group-hover:scale-110 transition-transform">
                                <Globe size={20} className="sm:w-6 sm:h-6" />
                            </div>
                            <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white mb-1 sm:mb-2">RDM</h3>
                            <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm mb-3 sm:mb-4 leading-relaxed line-clamp-2">
                                Kunjungi portal RDM (Rapor Digital Madrasah).
                            </p>
                            <span className="inline-flex items-center text-purple-600 dark:text-purple-400 font-semibold text-xs sm:text-sm group-hover:translate-x-2 transition-transform">
                                Buka Link <ArrowRight size={14} className="sm:w-4 sm:h-4 ml-1" />
                            </span>
                        </div>
                    </a>
